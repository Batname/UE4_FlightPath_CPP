...
FlightPathRootPath=/media/bat/SecondSSD/Projects/Unreal/FlightPath

gameProjectFile=/media/bat/SecondSSD/Projects/Unreal/FlightPath/FlightPath.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(FlightPathSource.pri)
include(FlightPathHeader.pri)
include(FlightPathConfig.pri)
include(FlightPathIncludes.pri)
include(FlightPathDefines.pri)
...
FlightPath-Linux-Debug.commands = $$build FlightPath Linux Debug  -project="\"$$gameProjectFile\"" $$args
FlightPath-Linux-DebugGame.commands = $$build FlightPath Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
FlightPath-Linux-Shipping.commands = $$build FlightPath Linux Shipping  -project="\"$$gameProjectFile\"" $$args
FlightPath-Linux-Test.commands = $$build FlightPath Linux Test  -project="\"$$gameProjectFile\"" $$args
FlightPath.commands = $$build FlightPath Linux Development  -project="\"$$gameProjectFile\"" $$args

FlightPathEditor-Linux-Debug.commands = $$build FlightPathEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
FlightPathEditor-Linux-DebugGame.commands = $$build FlightPathEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
FlightPathEditor-Linux-Shipping.commands = $$build FlightPathEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
FlightPathEditor-Linux-Test.commands = $$build FlightPathEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
FlightPathEditor.commands = $$build FlightPathEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	FlightPath-Linux-Debug \
	FlightPath-Linux-DebugGame \
	FlightPath-Linux-Shipping \
	FlightPath-Linux-Test \
	FlightPath \
	FlightPathEditor-Linux-Debug \
	FlightPathEditor-Linux-DebugGame \
	FlightPathEditor-Linux-Shipping \
	FlightPathEditor-Linux-Test \
	FlightPathEditor \
